...
class ManufactureController extends Controller
{
    ...
    public function save_manufacture(Request $request)
    {
        ...
        Session::put('message','Type added successfully !!');
    ...
    public function inactive_manufacture($manufacture_id)
    {
        ...
        DB::table('tbl_manufacture')
            ...
            Session::put('message','Type inactivated successfully !!');
            return Redirect::to('/all-manufacture');
    }
    ...
    public function active_manufacture($manufacture_id)
    {
        ...
        DB::table('tbl_manufacture')
            ...
            Session::put('message','Type activated successfully !!');
            return Redirect::to('/all-manufacture');
    }
    ...
    public function update_manufacture(Request $request,$manufacture_id)
    {
        ...
        DB::table('tbl_manufacture')
            ->where('manufacture_id',$manufacture_id)
            ->update($data);
            Session::put('message','Type updated successfully !');
            return Redirect::to('/all-manufacture');
    }
