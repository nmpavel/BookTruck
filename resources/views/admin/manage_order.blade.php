			...
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
			  ...
			  <tbody>
				...
				<td class="center">
					...
					<!-- <a class="btn btn-danger" href="{{URL::to('/inactive_category/'.$v_order->order_id)}}">
						<i class="halflings-icon white thumbs-down"></i>
					</a> -->
					
					<!-- <a class="btn btn-success" href="{{URL::to('/active_category/'.$v_order->order_id)}}">
					...
					<a class="btn btn-danger" href="{{URL::to('/delete-order/'.$v_order->order_id)}}" id=
						"delete">
